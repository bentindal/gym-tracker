  ...
  def view
    ...
    unless current_user.nil?
      ...
      all_friends.each do |friend|
        @is_friend = true if friend.follows == params[:id].to_i && friend.confirmed == true
        @pending = true if friend.follows == params[:id].to_i && friend.confirmed == false
      end
    end
    # do they follow back?
    @follows_back = false
    unless current_user.nil?
      ...
      all_friends.each do |friend|
        @follows_back = true if friend.user == params[:id].to_i && friend.confirmed == true
      end
    end
