...
class RegistrationsController < Devise::RegistrationsController
  ...
  def sign_up_params
    params.require(:user).permit(:first_name, :last_name, :email, :is_public, :password, :password_confirmation,
                                 :name)
  end

  def account_update_params
    params.require(:user).permit(:first_name, :last_name, :email, :is_public, :password, :name,
                                 :current_password)
  end
end
